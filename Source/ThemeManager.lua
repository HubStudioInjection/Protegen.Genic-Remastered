...
local ThemeManager = {} do
	ThemeManager.Folder = 'Wave Ware'
	-- if not isfolder(ThemeManager.Folder) then makefolder(ThemeManager.Folder) end

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['Default'] 		= { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"141313","AccentColor":"3b488d","BackgroundColor":"212121","OutlineColor":"3b488d"}') },
