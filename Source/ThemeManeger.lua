...
local ThemeManager = {} do
	ThemeManager.Folder = 'Col'
	-- if not isfolder(ThemeManager.Folder) then makefolder(ThemeManager.Folder) end

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['Default'] 		= { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"1c1c1c","AccentColor":"55ffb5","BackgroundColor":"141414","OutlineColor":"323232"}') },
